...
from customer_validation import Validation
...
def test_is_phone_number(validation):
    ...
    # True
    assert (validation.is_phone_number("0413 888 888")) 
...
def test_is_dob(validation):
    ...
    # True
    assert  (validation.is_dob("01/02/2000")) 

    # False
    assert (not validation.is_dob("01-02-2000"))
    assert (not validation.is_dob("01.02.2000"))
    assert (not validation.is_dob("2000/02/01"))
    assert (not validation.is_dob("2000.02.01"))
    assert (not validation.is_dob("2000-02-01"))
